...
public class CompressionFileRW implements FileJob {
    private static final String COMPRESSION_PATH = "G:\\BSUIR\\4 sem\\ООТПиСП\\Lab3\\Lab3Java\\compression";
    ...
    private static List<Class> loadPlugins2(String parentPackage) {
        List<Class> classes = new ArrayList<>();
        File pluginDir = new File(parentPackage);
